...
template <typename T, std::size_t N0, std::size_t N1> struct Matrix
{
    ...
    static constexpr std::size_t col_size() noexcept
    {
        return N0;
    }

    static constexpr std::size_t row_size() noexcept
    {
        return N1;
    }
    ...
    row_t &operator[](std::size_t i) noexcept
    {
        return data_[i];
    }
    const row_t &operator[](std::size_t i) const noexcept
    {
        return data_[i];
    }
